...
export const STYLE_PRESETS = {
  romantic: {
    id: "romantic",
    name: "Romântico",
    description: "Estilo suave e romântico com tons quentes",
    prompt: "romantic couple portrait, soft lighting, warm colors, dreamy atmosphere, bokeh background, golden hour, intimate moment, love, tender, emotional, cinematic quality",
    negativePrompt: "ugly, deformed, noisy, blurry, low contrast, cartoon, anime, sketch, drawing",
    strength: 0.65,
    icon: "heart",
  },
  anime: {
    id: "anime",
    name: "Anime",
    description: "Transforme em estilo anime japonês",
    prompt: "anime style, studio ghibli inspired, beautiful anime couple, detailed anime art, vibrant colors, clean lines, romantic anime scene, shoujo manga style, sparkles, cherry blossoms",
    negativePrompt: "realistic, photo, 3d render, ugly, deformed, western cartoon",
    strength: 0.75,
    icon: "sparkles",
  },
  pixar: {
    ...
    prompt: "pixar style 3d render, disney animation style, cute couple characters, big expressive eyes, smooth skin, vibrant colors, studio lighting, romantic scene, high quality 3d animation",
  ...
  watercolor: {
    id: "watercolor",
    name: "Aquarela",
    description: "Pintura em aquarela artística",
    prompt: "watercolor painting, romantic couple portrait, soft brushstrokes, pastel colors, artistic, delicate, flowing paint, paper texture, beautiful watercolor art, romantic atmosphere",
    negativePrompt: "photo, realistic, digital art, 3d, sharp edges, dark colors",
    strength: 0.7,
    icon: "palette",
  },
  vintage: {
    id: "vintage",
    name: "Vintage",
    description: "Estilo fotográfico retrô anos 70-80",
    prompt: "vintage photograph style, 1970s aesthetic, film grain, warm vintage tones, retro couple portrait, nostalgic atmosphere, soft focus, light leaks, analog photography feel",
    negativePrompt: "modern, digital, sharp, clean, anime, cartoon",
    strength: 0.6,
    icon: "camera",
  },
  oilpainting: {
    id: "oilpainting",
    name: "Pintura a Óleo",
    description: "Clássica pintura a óleo renascentista",
    prompt: "oil painting masterpiece, renaissance style portrait, couple portrait, dramatic lighting, rich colors, visible brushstrokes, classical art, museum quality, romantic painting",
    negativePrompt: "photo, modern, digital, cartoon, anime, flat colors",
    strength: 0.7,
    icon: "brush",
  },
} as const;
